...
public class DataPairTest {
	...
	public static void main(String[] args) {
		...
		// 3. 사용
		System.out.printf("%d:%s5=%n", isDataPair.getKey(), isDataPair.getValue() );
		System.out.printf("%d:%s5=%n", ssDataPair.getKey(), ssDataPair.getValue() );
		System.out.printf("%d:%s5=%n", ibDataPair.getKey(), ibDataPair.getValue() );
	}
