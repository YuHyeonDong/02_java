...
//	}
	 ...
	 * 문자열로 된 계자번호와
	 * 정수값의 잔액을 입력받아서
	 * 가각 계좌번호(accNumber)와 잔액(balance) 필드를 초기화 
	 * 하는
	 * 중복정의 된 생성자. 
	 * 
	 * 중복정의(Overloading)
...
//		value = 100; //선언이 안되서 사용못함.
	 ...
	 * 출금이 성공하면
	 * "얼마..가 출금되었습니다. 잔액은 얼마입니다." 라는 문자를 
	 * 리턴한다.
	 * 
	 * @param amount : int 출금하려는 금액
	 * @return String : 출금성공 실패 알림 문자열
	 */
